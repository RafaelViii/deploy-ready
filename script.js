...
// .payroll-summary-card.total-gross {
//   border-left-color: #10b981;
// }

// .payroll-summary-card.total-deductions {
//   border-left-color: #ef4444;
// }

// .payroll-summary-card.total-net {
//   border-left-color: #8b5cf6;
// }
...
//           <button id="goToManualUpdateBtn" class="btn-manual-update">✏️ Manual Inventory Update</button>
//         </div>
...
//           <button class="btn-manage-lab-types" id="manageLabTypesBtn">⚙️ Manage Lab Types</button>
//         </div>
...
//         <button class="btn-add-employee" id="addEmployeeBtn">+ Add Employee</button>
//         <button class="btn-generate-payroll" id="generatePayrollBtn">🔄 Calculate Payroll</button>
//         <button class="btn-print-payroll" id="printPayrollBtn">🖨️ Print Payroll</button>
//       </div>
//     </div>
...
//           <label for="cutoffType">Cut-off Type</label>
//           <select id="cutoffType">
//             <option value="1-15">1st Cut-off (1-15)</option>
//             <option value="16-end">2nd Cut-off (16-End of Month)</option>
//           </select>
//         </div>
//         <div class="period-input-group">
...
//           <input type="number" id="payrollYear" value="2025" min="2020" max="2099">
//         </div>
//       </div>
//     </div>
...
//           <!-- Payroll rows will be inserted here -->
//         </tbody>
//       </table>
//     </div>
//   </div>
...
//           <input type="text" id="empName" required placeholder="LASTNAME, FIRSTNAME">
//         </div>

//         <div class="form-group">
//           <label for="empPosition">Position *</label>
//           <input type="text" id="empPosition" required placeholder="e.g., HD STAFF NURSE">
//         </div>

//         <div class="form-group">
//           <label for="empDailyRate">Daily Rate *</label>
//           <input type="number" id="empDailyRate" step="0.01" required placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empBasicSalary">Basic Salary (Cut-off) *</label>
//           <input type="number" id="empBasicSalary" step="0.01" required placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empAllowance">Allowance</label>
//           <input type="number" id="empAllowance" step="0.01" value="0" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empHolidayPay">Holiday Pay</label>
//           <input type="number" id="empHolidayPay" step="0.01" value="0" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empOTHours">Overtime Hours</label>
//           <input type="number" id="empOTHours" step="0.01" value="0" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empSLVL">SL/VL Pay</label>
//           <input type="number" id="empSLVL" step="0.01" value="0" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empSSS">SSS</label>
//           <input type="number" id="empSSS" step="0.01" value="200" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empHDMF">HDMF (Pag-IBIG)</label>
//           <input type="number" id="empHDMF" step="0.01" value="250" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empPhilHealth">PhilHealth</label>
//           <input type="number" id="empPhilHealth" step="0.01" value="0" placeholder="0.00">
//         </div>

//         <div class="form-group">
//           <label for="empOtherDeductions">Other Deductions</label>
//           <input type="number" id="empOtherDeductions" step="0.01" value="0" placeholder="0.00">
//         </div>
//       </div>

//       <div class="form-actions" style="margin-top: 1.5rem;">
//         <button type="button" class="btn-cancel" id="cancelEmployeeBtn">Cancel</button>
...
if (salesPageLink) {
  salesPageLink.addEventListener('click', () => {
    ...
    // Format Datee
    //add function for db ts connection
